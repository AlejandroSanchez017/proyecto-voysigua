  ...
  const deletePersonasFromServer = async (cod_persona) => {
    try {
      ...
      if (response.ok) {
        ...
        return {
          success: false,
          message: responseBody || "No se pudo eliminar el persona.",
        };
      }
    } catch (error) {
      ...
      try {
        ...
        if (response.success) {
          setPersonas((prevPersonas) =>
            prevPersonas.filter(
              (persona) => persona.cod_persona !== cod_persona
            )
          );
          Swal.fire({
            icon: "success",
        ...
        <section className="content">
          <div className="card-header">
            <div className="titulo-contenedor">
              <h3 className="card-title">MODULO DE PERSONAS</h3>
            </div>
          </div>
          {/* FILTROS DEBAJO DEL TÍTULO */}
          <div className="filtros-contenedor">
            <button
              onClick={() => setShowNewPersonasRow(true)}
                ...
                {showNewPersonasRow && (
                  <tr className="new-personas-row">
                    ...
                    <td className="new-personas-cell">
                      <input
                        type="number"
                        className="new-personas-input"
                        value={newPersonasData.cod_tipo_persona}
                        onChange={(e) =>
                          setNewPersonasData({
                            ...newPersonasData,
                    ...
                    <td className="new-personas-cell">
                      <input
                        type="text"
                        className="new-personas-input"
                        value={newPersonasData.primer_nombre}
                        onChange={(e) =>
                          setNewPersonasData({
                            ...newPersonasData,
                    ...
                    <td className="new-personas-cell">
                      <input
                        type="text"
                        className="new-personas-input"
                        value={newPersonasData.apellido}
                        onChange={(e) =>
                          setNewPersonasData({
                            ...newPersonasData,
                    ...
                    <td className="new-personas-cell">
                      <input
                        type="date"
                        className="new-personas-input"
                        value={newPersonasData.fecha_nacimiento}
                        onChange={(e) =>
                          setNewPersonasData({
                            ...newPersonasData,
                    ...
                    <td className="new-personas-cell">
                      ...
                      <button
                        onClick={() => setShowNewPersonasRow(false)}
